...
[train_central_im, train_sum_im_v, train_sum_im_h, train_sum_im_t] = sumAllApertures( LF , 40);
...
%%
[trained_mean, trained_std] = train_params(train_sum_im_t, 40);  
...
[sat_central_im, sum_im_v, sum_im_h, sum_im_t] = sumAllApertures( LF , 40 );
